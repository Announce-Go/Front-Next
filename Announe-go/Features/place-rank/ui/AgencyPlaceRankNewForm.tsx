...
export function AgencyPlaceRankNewForm({ advertisers }: Props) {
  ...
  const handleSubmit = async () => {
    ...
    if (!url.trim()) { toast.warning("플레이스 URL을 입력해주세요."); return }
  ...
  return (
    ...
    >
      ...
      <div className="space-y-1.5">
        ...
        <input
          type="text"
          placeholder="https://place.naver.com/place/12345678"
          value={url}
              ...
              return (
                ...
                >
                  ...
                  <span
                    ...
                    style={{ color: isSelected ? "#06b6d4" : "#94a3b8" }}
                  >
                    {adv.company_name}
                  </span>
                </label>
