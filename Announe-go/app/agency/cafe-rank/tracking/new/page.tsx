...
import { AgencyCafeRankNewForm } from "@/Features/cafe-rank/ui/AgencyCafeRankNewForm"
...
export default async function AgencyCafeRankNewPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-bold text-white">카페 글 순위 추적 등록</h1>
          </div>
      ...
      <div className="relative">
        <AgencyCafeRankNewForm advertisers={advertisers} />
      </div>
    </div>
  )
}
