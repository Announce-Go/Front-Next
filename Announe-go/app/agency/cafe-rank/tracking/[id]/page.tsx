import { AgencyCafeRankTrackingDetail } from "@/Features/cafe-rank/ui/AgencyCafeRankTrackingDetail"

type PageProps = {
  params: Promise<{ id: string }>
}

export default async function AgencyCafeRankTrackingDetailPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <AgencyCafeRankTrackingDetail trackingId={Number(id)} />
      </div>
    </div>
  )
}
