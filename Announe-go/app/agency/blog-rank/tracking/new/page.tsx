...
import { AgencyBlogRankNewForm } from "@/Features/blog-rank/ui/AgencyBlogRankNewForm"
...
export default async function AgencyBlogRankNewPage() {
  ...
  return (
    ...
    >
      ...
      <div className="relative flex items-center justify-between mb-8">
        <div>
          <div className="flex items-center gap-3 mb-1">
            ...
            <h1 className="text-2xl font-bold text-white">블로그 글 순위 추적 등록</h1>
          </div>
      ...
      <div className="relative">
        <AgencyBlogRankNewForm advertisers={advertisers} />
      </div>
    </div>
  )
}
