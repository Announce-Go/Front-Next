import { AgencyBlogRankTrackingDetail } from "@/Features/blog-rank/ui/AgencyBlogRankTrackingDetail"

type PageProps = {
  params: Promise<{ id: string }>
}

export default async function AgencyBlogRankTrackingDetailPage({ params }: PageProps) {
  ...
  return (
    ...
    >
      ...
      <div className="relative">
        <AgencyBlogRankTrackingDetail trackingId={Number(id)} />
      </div>
    </div>
  )
}
