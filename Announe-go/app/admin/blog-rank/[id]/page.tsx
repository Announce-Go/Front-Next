...
export default function BlogRankDetailPage() {
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      ...
      <div className="flex items-center justify-between mb-6">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-2xl font-bold text-slate-900">블로그 순위 추적 상세</h1>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        
        {/* 2. 좌측: 기본 정보 및 상태 (Emerald Theme) */}
        <div className="lg:col-span-1 space-y-6">
          <Card className="shadow-sm border-t-4 border-t-emerald-500">
            <CardHeader>
              <div className="flex justify-between items-start">
                <div>
                   <Badge className="bg-emerald-100 text-emerald-700 hover:bg-emerald-200 border-0 mb-2">
                    추적중
                  </Badge>
                  <CardTitle className="text-2xl font-bold text-slate-900">강남한의원</CardTitle>
                </div>
                {/* 블로그 아이콘 적용 */}
                <FileText className="w-8 h-8 text-emerald-600 p-1.5 bg-emerald-50 rounded-full" />
              </div>
            ...
            <CardContent className="pt-6 space-y-4">
              ...
              <div className="space-y-1">
                <label className="text-xs font-medium text-slate-500">블로그 포스팅 URL</label>
                <div className="flex items-center gap-2">
                  <p className="text-sm text-slate-700 truncate underline decoration-slate-300 underline-offset-4 cursor-pointer hover:text-emerald-600">
                    https://blog.naver.com/myblog/1234...
                  </p>
          ...
          <Card className="bg-emerald-50/50 border-emerald-100 shadow-sm">
            <CardContent className="p-4 flex flex-col gap-4">
                <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-emerald-800">이번 회차 최고 순위</span>
                    <span className="text-xl font-bold text-emerald-700">1위</span>
                </div>
                <Separator className="bg-emerald-200/60" />
                <div className="flex items-center justify-between">
                    <span className="text-sm font-medium text-emerald-800">평균 노출 순위</span>
                    <span className="text-xl font-bold text-emerald-700">2.8위</span>
                </div>
            </CardContent>
          </Card>
        </div>
        ...
        {/* 3. 우측: 순위 히스토리 (Timeline - Emerald Theme) */}
            ...
            <CardHeader className="pb-3 bg-slate-50/50 rounded-t-lg border-b">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                   ...
                   <Badge className="bg-emerald-500 hover:bg-emerald-600 text-white">진행중</Badge>
                </div>
                ...
                <div className="divide-y">
                    ...
                    <div className="flex items-center justify-between p-4 hover:bg-slate-50 transition-colors">
                        <div className="flex items-center gap-4">
                            ...
                            <div className="flex items-center gap-2">
                                ...
                                <span className="font-semibold text-emerald-700">2위</span>
                            </div>
                        </div>
                    ...
                    <div className="flex items-center justify-between p-4 hover:bg-slate-50 transition-colors bg-yellow-50/30">
                         <div className="flex items-center gap-4">
                            ...
                            <Separator orientation="vertical" className="h-8 bg-yellow-200" />
                            <div className="flex items-center gap-2">
          ...
          <Card className="shadow-sm border-l-4 border-l-slate-400 opacity-90">
            ...
            <CardContent className="p-0">
               <div className="flex items-center justify-center p-6 text-muted-foreground bg-slate-50/30">
                  <span className="text-sm flex items-center gap-2 hover:text-slate-900 cursor-pointer">
